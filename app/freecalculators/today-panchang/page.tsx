        ...
        >
          ...
          <div className="w-full max-w-6xl">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
              ...
              <div className="bg-white rounded-lg p-4 shadow-md border border-indigo-200">
              ...
              <div className="bg-white rounded-lg p-4 shadow-md border border-indigo-200">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <label className="text-xs text-indigo-600 font-medium mb-2 block">Location Settings</label>
                    <div className="space-y-2">
                      ...
                      {!isLocationEnabled && (
                        <div className="grid grid-cols-2 gap-2">
                          <input
                            ...
                            className="px-2 py-1 border border-indigo-300 rounded text-xs focus:outline-none focus:ring-1 focus:ring-indigo-500 bg-white text-gray-900 font-medium hover:border-indigo-400 transition-all duration-200"
                            step="0.000001"
                          />
                          <input
                            type="number"
                      ...
                      {isLocationEnabled && currentLocation && (
                        <div className="px-2 py-1 bg-green-50 border border-green-200 rounded text-xs">
              ...
              <div className="bg-white rounded-lg p-4 shadow-md border border-indigo-200">
                <div className="flex items-center gap-3">
                  <RefreshCw className="text-indigo-600 w-5 h-5 flex-shrink-0" />
                  <div className="flex-1">
                    <label className="text-xs text-indigo-600 font-medium mb-1 block">Actions</label>
                    <button
                      onClick={refetch}
                      disabled={loading}
                      className="w-full px-3 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 disabled:opacity-50 flex items-center justify-center gap-2 font-medium transition-all duration-200 hover:shadow-md disabled:cursor-not-allowed text-sm"
                    >
