...
export default function ServicesPage() {
  ...
  const transformServiceForShowcase = (service: Service, index: number) => {
    ...
    const consultationType =
      ...
      consultationTypes[index % consultationTypes.length];
    const duration = service.duration || "45 mins";
    const rating = ratings[index % ratings.length];

    // Get primary image from service media
    const primaryImage =
      service.service_media?.find((media) => media.is_primary)?.media_url ||
    ...
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-amber-50 via-white to-orange-50 -mt-4">
      ...
      <MysticBackground>
        ...
        <div className="container mx-auto pt-8 px-4 relative z-10">
          ...
          >
            Embark on a transformative journey with our comprehensive range of
            spiritual services. Let our expert astrologers and spiritual guides
