        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex flex-wrap gap-2 mb-6 border-b border-gray-200">
              {tabKeys.map((tabKey) => (
                <button
                  ...
                  className={`px-4 py-2 text-sm font-medium border-b-2 transition-colors font-sans ${
                    activeTab === tabKey
            ...
            {activeTab === "about.tabs.0" && (
              ...
              >
                <h2
                  className="text-3xl font-bold text-indigo-900 mb-6 border-b pb-2"
                ...
                <div className="mb-8 space-y-6">
                  {[
                    ...
                    <motion.div
                      ...
                      viewport={{ once: true }}
                      className={`bg-gradient-to-r ${card.gradient} p-6 rounded-xl border ${card.borderColor}`}
                    >
                      <div className="flex items-start gap-4">
                        <div className={`${card.iconColor} mt-1`}>
                          {card.icon}
                        </div>
                        <div className="flex-1">
                          <p 
                            className={`${card.textColor} leading-relaxed text-base`}
                            style={{ fontFamily: "Open Sans, Arial, sans-serif" }}
                          >
                            {t(`about.journey.story.${i}`)}
                          </p>
                        </div>
                      </div>
                    </motion.div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    {coreValues.map((value, idx) => (
                      ...
                      >
                        ...
                        <div>
                          <h4
                            className="font-bold text-indigo-900 mb-2"
                            style={{ fontFamily: "Playfair Display, serif" }}
                          >
                            {value.title}
                          </h4>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-lg border border-green-100">
                    <span className="text-green-800 font-bold text-lg">
                      {t("about.mission.impactTitle")}
                    </span>
                    <span className="text-gray-800 font-semibold ml-2">
                      {t("about.mission.impactText")}
                    </span>
                  </div>
                </div>
              </motion.section>
            ...
            <div className="sticky top-8 space-y-6">
              ...
              <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-md">
                ...
                <ul className="space-y-3">
                  {[0, 1, 2, 3].map((i) => (
                    <li key={i}>
                      <a
                        href={t(`about.resources.link${i}.url`)}
                        className="text-indigo-700 hover:text-indigo-900 hover:underline flex items-start transition-colors"
                      >
                        <ArrowUpRight className="w-4 h-4 mr-2 mt-1 text-indigo-500" />
                        <span className="text-sm">
                          {t(`about.resources.link${i}.title`)}
                        </span>
                      </a>
                    </li>
                  ))}
              ...
              <div className="bg-white rounded-lg p-6 border border-gray-200 shadow-md">
                ...
                <div className="space-y-3 text-sm text-gray-700">
                  ...
                  <p>
                    Our expert astrologers are here to guide you with
                    personalized insights and remedies.
                  </p>
                  <button
