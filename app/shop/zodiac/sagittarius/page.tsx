  ...
  return (
    <>
      ...
      >
        ...
        <UniversalZodiacBanner signKey="sagittarius" />

        {/* HORIZONTAL DROPDOWN NAVIGATION */}
        <ZodiacInfoNavigation zodiacSign="sagittarius" />
        ...
        >
          <div className="max-w-7xl mx-auto p-4 pt-8 sm:p-8 sm:pt-12 w-full">
            {/* Sagittarius Product Grid (replace with your sagittarius products) */}
            {/* Example: <ReusableProductGrid products={sagittariusProducts} columns={4} mobileColumns={2} gap="md" />; */}
          </div>
        </motion.div>
        ...
        {/* GLOBAL STYLES FOR REFINED SAGITTARIUS THEME */}
        <style jsx global>{`
          ...
          .sagittarius-warm-animation {
            position: relative;
            overflow: hidden;
          }
          .sagittarius-warm-animation::before {
            content: '';
            position: absolute;
            top: -50%;
            left: -50%;
          ...
          .jupiter-energy-pulse {
            animation: jupiterEnergy 4s ease-in-out infinite;
          }
          @keyframes jupiterEnergy {
            0%, 100% { 
