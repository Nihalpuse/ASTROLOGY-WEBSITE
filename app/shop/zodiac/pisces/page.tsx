  ...
  return (
    <>
      ...
      >
        ...
        <ZodiacInfoNavigation zodiacSign="pisces" />
        ...
        >
          <div className="max-w-7xl mx-auto p-4 pt-8 sm:p-8 sm:pt-12 w-full">
            {/* Pisces Product Grid (replace with your pisces products) */}
            {/* Example: <ReusableProductGrid products={piscesProducts} columns={4} mobileColumns={2} gap="md" />; */}
          </div>
        </motion.div>
