  ...
  return (
    <>
      ...
      >
        ...
        <UniversalZodiacBanner signKey="leo" />

        {/* HORIZONTAL DROPDOWN NAVIGATION */}
        <ZodiacInfoNavigation zodiacSign="leo" />
        ...
        >
          <div className="max-w-7xl mx-auto p-4 pt-8 sm:p-8 sm:pt-12 w-full">
            {/* Leo Product Grid (replace with your leo products) */}
            {/* Example: <ReusableProductGrid products={leoProducts} columns={4} mobileColumns={2} gap="md" />; */}
          </div>
        </motion.div>

        {/* GLOBAL STYLES FOR REFINED LEO THEME */}
        <style jsx global>{`
          ...
          .sun-energy-pulse {
            animation: sunEnergy 4s ease-in-out infinite;
          }
          @keyframes sunEnergy {
            0%, 100% { 
